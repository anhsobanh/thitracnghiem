...
function exportHTML() {
    ...
    outputEditor.setValue("<table>" + a + enter + "</table>");
    initMouseAction();
}
...
$(function () {
    $("#generate").on("click", function () {
        ...
        if (isInt(cols))if (isInt(rows)) {
            $("#tableWrap").empty().append("<table><thead style='display: none'><tr></tr></thead><tbody></tbody></table>");
    ...
    $("#addRow").on("click", function (e) {
        ...
        for (var e = 1; e <= cols; e++) {
            $("#tableWrap tbody>tr:last").append("<td class='c" + (e - 1) + " r" + rows + "' colspan='1' rowspan='1'><div contenteditable='true'>&nbsp;</div></td>");
        }
        $("#rows").val(rows + 1);
        exportHTML();
    });
    $("#addCol").on("click", function (e) {
        cols = parseInt($("#cols").val(), 10);
        rows = parseInt($("#rows").val(), 10);
        $("#tableWrap thead>tr").append("<th class='c" + cols + "'><div contenteditable='true'>&nbsp;</div></th>");
        $("#tableWrap tbody>tr").each(function (i) {
    ...
    $("#delRow").on("click", function (e) {
        $("#tableWrap tbody>tr:not(:last)").each(function (index) {
        ...
        $("#tableWrap tbody>tr:last").remove();
    ...
    $("#delCol").on("click", function (e) {
        ...
        $("#tableWrap thead>tr>th:last").remove();
